...
describe('Login functionality', () => {
    it('Valid Login', async () => {    //Test case №1
        ...
        await LoginPage.loginWithCredentials('standard_user', 'secret_sauce'); //Login with valid credentials
    ...
    it('Login with invalid password', async () => {    //Test case №2
        ...
        await LoginPage.loginWithCredentials('standard_user', 'not_a_secret_sauce'); // Login with invalid password
    ...
    it('Login with invalid Login', async () => {     //Test case №3
        ...
        await LoginPage.loginWithCredentials('not_a_standard_user', 'secret_sauce'); // Login with invalid login (further steps are similar to previous test)
...
describe('Cart functionality', () => {    
    it('Saving the cart after logout', async () => {    //Test case №5
        ...
        await LoginPage.loginWithCredentials('standard_user', 'secret_sauce'); // another login with valid data
...
describe('Footer', () => {
    it('Footer Links', async () => {        //Test case №7
        ...
        await LoginPage.loginWithCredentials('standard_user', 'secret_sauce'); // another valid login
